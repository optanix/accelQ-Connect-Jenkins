...
public class AQPluginBuilderAction extends Builder implements SimpleBuildStep {
    ...
    public AQPluginBuilderAction(String jobId, String userName, String secretKey, String projectName, String appURL) {
        this.jobId = jobId;
    ...
    public void perform(@Nonnull Run<?, ?> run, @Nonnull FilePath workspace, @Nonnull Launcher launcher, @Nonnull TaskListener listener) throws InterruptedException, IOException {
        ...
        if(aqPluginRESTClient.doLogin(this.userName, this.secretKey, this.projectName)) {
            ...
            out.println();
            JSONObject realJobObj = aqPluginRESTClient.triggerJob(Integer.parseInt(jobId));
            ...
            listener.hyperlink(String.format(aqPluginRESTClient.getBaseURL() + AQPluginConstants.JOB_WEB_LINK, Long.toString(realJobPid)), "link");
